...
const MainPage = ({serverStatus}) => {
    ...
    <div className="bg-white-to-green min-h-screen">
        ...
        <CardCollection title={"Popular categories"}items={categories} cols={3} />
